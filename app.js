...
const mainContent = `<h2 class="sub-header">
          Name Your Price is an online browser game inspired by "The Price Is Right"
        </h2>
        <p class="para-text">
          <span class="span-one">Name Your Price</span> is an online browser game where you have to guess the price of
