...
const questionOne = `<h2 class="sub-header">
          (new title) an online browser game inspired by "The Price Is Right"
        </h2>
        <p class="para-text">
          (title) is a online browser game where you have to guess the price of
